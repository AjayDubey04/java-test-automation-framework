package com.vtiger.pages.inventry.invoice;

import org.apache.commons.lang3.RandomStringUtils;

import com.vtiger.orlayer.InventoryInvoiceNewCreateInvoiceOr;
...
public  class InventoryInvoiceNewCreateInvoice  extends InventoryInvoiceNewCreateInvoiceOr{
	...
	public  String fillUpInvoiceInformation(String expSubjectName) {
		...
		String rsndomName=RandomStringUtils.randomAlphanumeric(5);
		
		wt.sendKeys(getExpSubjectNameTB(),rsndomName);
		wt.sendKeys(getCustomerNumberTB(), ""+rsndomName+".er@gmail.com");
